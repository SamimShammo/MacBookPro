...
document.getElementById('apply-btn').addEventListener('click',function(){
    ...
    if(userPromo == 'stevekaku'){
        const totalPrice = document.getElementById('total-price').innerText; // Getting the total price
        let newPrice = totalPrice - ((totalPrice * 20) / 100); // Calculating New Price After Reducing the Discount
        document.getElementById('totalFooter').innerText = parseInt(newPrice); // Updating New Discount Price
    }
    else{
